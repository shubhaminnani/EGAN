...
#    CDRSeg_weights_path = "./weights/generator_50_mnv2.h5
    CDRSeg_weights_path = []
#    CDRSeg_weights_path.append('./weights/skin_eff4_latest/generator_10.h5')
#    CDRSeg_weights_path.append("./weights/skin_eff4_latest/generator_20.h5")
#    CDRSeg_weights_path.append("./weights/skin_eff4_latest/generator_30.h5")
    CDRSeg_weights_path.append("./weights/generator_30.h5")
#    CDRSeg_weights_path.append("./weights/weights5.h5")
    CDRSegGAN_model = sm.Unet('efficientnetb4', input_shape=(512,512,3), classes=2, activation='sigmoid')
    ...
    CDRSeg_model = sm.Unet('efficientnetb4', input_shape=(512,512,3), classes=2, activation='sigmoid')
...
#    weight_path = CDRSeg_weights_path[0]
